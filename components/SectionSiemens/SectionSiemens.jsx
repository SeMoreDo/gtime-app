...
export default function EmailBanner() {
  ...
  return (
    <div className={classes.wrapper}>
      ...
      <Image src={'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Siemens_Energy_logo.svg/1200px-Siemens_Energy_logo.svg.png'} className={classes.image} />
    </div>
  );
}